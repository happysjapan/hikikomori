      ...
      <div class="detail">
        <div class="detail--content">
          <div class="columns">
            ...
            <h3 class=detail--single_title><?php the_title(); ?>ひきこもり・家庭内暴力相談窓口</h3>

            <div class="detail--clinic_header">
              <div class="row">
           ...
           <h3 class="detail--clinic__title">相談窓口の対象となる方</h3>
          ...
          <h3 class="detail--clinic__title">窓口利用の流れ</h3>
          <div class="detail--clinic__text">
            <?php echo get_field('clinic_target'); ?>
         </div>
         <!-- Button -->
         ...
         <!-- end of button -->
          ...
          <h3 class="detail--clinic__title"><?php the_title(); ?>の支援施設・センター・病院</h3>
          <div class="detail--clinic__text">
           <?php echo get_field('clinic_target'); ?>
          </div>
          <!-- Button -->
