...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    clean: {
            clean: ['dist/**/*.html', 'dist/css', 'dist/svg', 'dist/js', 'dist/fonts'],
            all: ['dist/']
    },
    ...
    copy: {
      dist: {
        files: [{
          expand: true,
          cwd: 'src/',
          src: ['css/*.css', 'images/svg/*.svg', 'images/common/favicon.ico', 'js/*.js', 'bower_components/*/dist/*', 'images/*.mp4', 'fonts/*'],
          dest: 'dist/',
        }]
      }
    },
    ...
    rsync: {
      ...
      stage: {
        options: {
          ...
          dest: "/home/the-concrete/www/happys/wp-content/themes/happys",
          delete: true,
        }
      },
      themes: {
        options: {
          src: "wp/wp-content/themes/happys/",
